---
title: 'SeqArray: an R/Bioconductor Package for Big Data Management of Genome-Wide
  Sequencing Variants'
...
output:
  ...
  pdf_document:
    ...
    toc_depth: 3
vignette: |
  %\VignetteIndexEntry{SeqArray Tutorial} %\VignetteDepends{gdsfmt} %\VignetteKeywords{GWAS, SNP, Variants} %\VignetteEngine{knitr::rmarkdown}
---
