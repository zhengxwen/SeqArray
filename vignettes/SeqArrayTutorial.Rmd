...
| seqSummary   | Gets the summary of a sequence GDS file (Num. of samples, Num. of variants, INFO/FORMAT variables, etc)  |
...
| Function       | Description |
|:---------------|:-------------------------------------------|
| seqGetData     | Gets data from a sequence GDS file (from a subset of data). [LINK](http://zhengxwen.github.io/SeqArray/devel/help/seqGetData.html)  |
...
| seqAlleleCount | Allele counts. [LINK](http://zhengxwen.github.io/SeqArray/devel/help/seqAlleleCount.html)  |
| ...            | [LINK](http://zhengxwen.github.io/SeqArray/devel/help/00Index.html)  |
