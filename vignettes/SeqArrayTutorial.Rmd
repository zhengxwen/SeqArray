---
title: "SeqArray -- Big Data Management of Whole-Genome Sequence Variant Calls"
...
| seqGetData   | Gets data from a SeqArray GDS file (from a subset of data). [![](link.png)](http://zhengxwen.github.io/SeqArray/release/help/seqGetData.html)  |
...
# maximize the access speed with LZ4 compression algorithm
seqVCF2GDS(vcf.fn, "tmp.gds", storage.option="LZ4_RA.max", verbose=FALSE)
