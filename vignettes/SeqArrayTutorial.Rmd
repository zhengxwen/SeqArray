...
afreq <- seqApply(genofile, "genotype",
...
dm <- seqSummary(genofile, "genotype", verbose=FALSE)$seldim
genmat <- genmat / (sum(diag(genmat)) / dm[2L])
...
afreq <- seqApply(genofile, "genotype", RefAlleleFreq, as.is="double", margin="by.variant")
