...
|:-------------|:-------------------------------------------|
| seqVCF2GDS   | Reformats VCF files. [![](link.png)](http://zhengxwen.github.io/SeqArray/release/help/seqVCF2GDS.html)  |
| seqSetFilter | Defines a data subset of samples or variants. [![](link.png)](http://zhengxwen.github.io/SeqArray/release/help/seqSetFilter.html)  |
| seqGetData   | Gets data from a SeqArray file with a defined filter. [![](link.png)](http://zhengxwen.github.io/SeqArray/release/help/seqGetData.html)  |
...
head(af)
```
where the argument `cl` specifies the number of cores, the user-defined function `function(f) {...}` is distributed to 2 different computing cores, and `split` indicates dividing genotypes according to different variants.
...
res <- regression(seqData, outcome="pheno", covar="age")
head(res)
```
```{r echo=FALSE}
data.frame(variant.id=1:6, n=rep(559L, 6),
    freq=c(0.6905188, 0.9418605, 0.9991055, 0.9991055, 0.9373882, 0.9991055),
    Est=c(0.09989598, 0.14390294, 1.90773195, 0.28690807, 0.12340020, -2.20965585),
    SE=c(0.06692225, 0.12943936, 0.97923589, 0.98135431, 0.12548274, 0.97798263),
    Wald.Stat=c(2.22820413, 1.23596634, 3.79542189, 0.08547396, 0.96708299, 5.10489710),
    Wald.Pval=c(0.13551127, 0.26624986, 0.05139292, 0.77001192, 0.32540875, 0.02385839))
```
